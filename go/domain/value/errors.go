...
const (
	...
	ERR_CAR_PROFILE_NOT_SELECTED        ErrCode = "ERR_CAR_PROFILE_NOT_SELECTED"
	ERR_INVALID_ADDITIONAL_PRICE_RANGE  ErrCode = "ERR_INVALID_ADDITIONAL_PRICE_RANGE"
	ERR_INVALID_PROMOTION_PAYMENT_USAGE ErrCode = "ERR_INVALID_PROMOTION_PAYMENT_USAGE"
...
var (
	...
	ErrInvalidReferralCode = TacoError{ERR_INVALID_REFERRAL_CODE, "invalid referral code"}
	...
	ErrCarProfileNotSelected = TacoError{ERR_CAR_PROFILE_NOT_SELECTED, "car profile is not selected"}
