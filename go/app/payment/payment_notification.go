...
func NewPaymentSuccessNotification(paymentOrder entity.UserPaymentOrder) entity.Event {
	...
	return command.NewRawMessageCommand(paymentOrder.UserId, messageTitle, "", map[string]string{})
}
...
func NewPaymentFallbackNotification(
	...
	return command.NewRawMessageCommand(failedUserPayment.UserId, messageTitle, messageBody, map[string]string{})
}
...
func NewPaymentFailedNotification(userId string) entity.Event {
	...
	return command.NewRawMessageCommand(userId, messageTitle, messageBody, map[string]string{})
}
...
func NewPaymentRecoveryNotification(recoveredUserPayment entity.UserPayment) entity.Event {
	...
	return command.NewRawMessageCommand(recoveredUserPayment.UserId, messageTitle, "", map[string]string{})
}
