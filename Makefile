...
docker_outbox_build_prod: docker_server_build_base
	docker build --tag 069049357473.dkr.ecr.ap-northeast-2.amazonaws.com/taco/taco-backend-outbox:latest . -f ./docker/Dockerfile.outbox.prod
...
docker_build: docker_server_build_base 

docker_build_prod: docker_server_build_prod docker_outbox_build_prod

run_local: docker_build_local
	docker-compose -f ./docker/docker-compose.yaml up -d
	./schemas/migration.sh
